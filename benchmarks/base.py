...
class BenchmarkSuite:
    ...
    def measure_scenario(self, name: str, scenario_func) -> ScenarioResult:
        ...
        try:
            ...
            result = scenario_func(self._measure_component)
            success = True
    ...
    def generate_report(self):
        report = {
            ...
            'summary': {
                ...
                'average_response_time': sum(r.total_duration_ms for r in self.results) / len(self.results),
                'total_tokens_processed': sum(r.total_input_tokens + r.total_output_tokens for r in self.results)
            },
